<script>
	import { initState, parseMarginLeft, parseTextSize, parseTotalCards } from './util';
  import { page } from "$app/stores";
	import CharacterDisplay from './CharacterDisplay.svelte';

  const {textSize, textColor, distance, layout, transparent, shadowSize, shadowColor} = Object.fromEntries($page.url.searchParams.entries())
